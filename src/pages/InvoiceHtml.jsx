...
export default function InvoiceHtml() {
  ...
  const customerKey = useMemo(() => {
    if (!invoice) return "";
    return encodeURIComponent(String(invoice.customerEmail || invoice.customer || "").toLowerCase().trim());
  }, [invoice]);
        ...
        <div className="invhtml-shell">
          <div className="invhtml-topbar">
            ...
            <div className="invhtml-actions noprint">
              <Link className="invhtml-btn" to="/portal/unknown">
                Back
              </Link>
            </div>
          </div>
  ...
  function onOpenInvoice(nextId) {
    navigate(`/invoice/${encodeURIComponent(nextId)}`);
  }
    ...
    <div className="invhtml-root">
      <div className="invhtml-shell">
        <div className="invhtml-topbar">
          ...
          <div className="invhtml-actions noprint">
            <Link className="invhtml-btn" to={`/portal/${customerKey}`}>
              Back
            </Link>
            <button
        ...
        <div className="invhtml-card">
          <div className="invhtml-header">
            ...
            <div className="invhtml-right">
              <div className="invhtml-company">
                <div className="invhtml-companyname">TabbyPay (Pty) Ltd</div>
          ...
          <div className="invhtml-footer">
            <div className="invhtml-muted">
              This invoice is accessible via URL for email linking. Use Print or Save as PDF from your browser.
            </div>
