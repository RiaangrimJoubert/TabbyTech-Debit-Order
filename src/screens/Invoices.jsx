    ...
    <div className="tt-invCard">
      <div className="tt-invHeadInner">
        ...
        <div className="tt-actions">
          ...
          <button type="button" className="tt-btn" onClick={() => onToast("Print will be enabled when we wire PDF/print layout.")}>
            Print
          </button>

          <button type="button" className="tt-btn" onClick={() => onToast("Download will be enabled when we wire PDF export.")}>
            Download
          </button>
